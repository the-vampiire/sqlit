...
The canonical provider registry lives in `sqlit.domains.connections.providers.registry`.
"""
...
def get_connection_schema(db_type: str) -> ConnectionSchema:
    from sqlit.domains.connections.providers.registry import get_connection_schema as _get_connection_schema
...
def get_all_schemas() -> dict[str, ConnectionSchema]:
    ...
    from sqlit.domains.connections.providers.registry import get_all_schemas as _get_all_schemas
...
def is_file_based(db_type: str) -> bool:
    ...
    """
    from sqlit.domains.connections.providers.registry import is_file_based as _is_file_based
...
def has_advanced_auth(db_type: str) -> bool:
    ...
    """
    from sqlit.domains.connections.providers.registry import has_advanced_auth as _has_advanced_auth
...
def supports_ssh(db_type: str) -> bool:
    ...
    """
    from sqlit.domains.connections.providers.registry import supports_ssh as _supports_ssh
...
def get_default_port(db_type: str) -> str:
    ...
    """
    from sqlit.domains.connections.providers.registry import get_default_port as _get_default_port
...
def get_display_name(db_type: str) -> str:
    ...
    """
    from sqlit.domains.connections.providers.registry import get_display_name as _get_display_name
